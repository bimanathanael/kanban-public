...
var _default = {
  ...
  methods: {
    ...
    onSignIn: function onSignIn(googleUser) {
      ...
      this.$gAuth.signIn().then(function (result) {
        ...
        (0, _axios.default)({
          ...
          console.log("sukses login", result);
          _this2.isLogin = true;
          _this2.UserId = result.data.id;

          _this2.$emit("emitProcessLoginGoogle", result.data.access_token, result.data.id);
        }).catch(function (err) {
          console.log(err.response.data.message, "err");
          _this2.showError = true;
          _this2.errMsg = err.response.data.message;
        });
      }).catch(function (err) {
        console.log(err);
      });
  ...
  return _c("div", { staticClass: "containerIndex" }, [
    _c("div", { staticClass: "d-flex justify-content-center" }, [
      _c("div", { staticClass: "d-flex align-items-center flex-column" }, [
        _c("h1", { staticClass: "titleIndex" }, [_vm._v("Login")]),
        _vm._v(" "),
        _vm.showError
          ? _c(
              "label",
        ...
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _c("div", { staticClass: "input-group mb-4 mt-" }, [
              _vm._m(1),
              _vm._v(" "),
              _c("input", {
                directives: [
  ...
  methods: {
    ...
    processRegister: function processRegister() {
      ...
      (0, _axios.default)({
        ...
        _this.errMsg = null;
        _this.succMsg = "Sucess register, please login";
        _this.registerEmail = null;
        _this.registerPassword = null;
        _this.confirmPass = null;
      }).catch(function (err) {
        console.log(err);
        console.log(err.response.data.message, "err");
        _this.showError = true;
  ...
  methods: {
    moveTo: function moveTo(id, title, target, event) {
      ...
      (0, _axios.default)({
        ...
        _this.$emit("reloadPageMoveTo");
      }).catch(function (err) {
        console.log(err);
      });
    },
    processDelete: function processDelete(event) {
      var _this2 = this;
            ...
            _c(
              "form",
              {
                ...
                on: {
                  submit: function($event) {
                    $event.preventDefault()
                    return _vm.processAddTask($event)
                  }
                }
              },
              [
...
exports.default = _default;
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "containerHome" }, [
    _c(
      "div",
          ...
          _vm.loginPage && !_vm.registerPage && !_vm.isLogin
            ? _c("Login", {
                on: {
                  ...
                  emitProcessLoginGoogle: _vm.processLogin
                }
              })
            : _vm._e(),
          _vm._v(" "),
...
},{"vue":"node_modules/vue/dist/vue.runtime.esm.js","./App.vue":"src/App.vue","vue-google-oauth2":"node_modules/vue-google-oauth2/index.js"}],"../../../../../../../../../usr/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
